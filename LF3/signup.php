...
<div id="pageMiddle">
  ...
  <form name="signupform" id="signupform" onsubmit="return false;">
	...
	<div>Nume:</div>
    <input id="nume" type="text" onfocus="emptyElement('status')" maxlength="88">
	<div>Prenume:</div>
    <input id="prenume" type="text" onfocus="emptyElement('status')" maxlength="88">
	<div>CNP:</div>
    <input id="cnp" type="text" onfocus="emptyElement('status')" maxlength="13">
	<div>Numar-telefon:</div>
    <input id="telefon" type="text" onfocus="emptyElement('status')" maxlength="88">
    <div>Email Address:</div>
    <input id="email" type="text" onfocus="emptyElement('status')" maxlength="88">
	<div>Adresa:</div>
    <input id="adresa" type="text" onfocus="emptyElement('status')" maxlength="88">
    <div>Create Password:</div>
    <input id="p1" type="password" onfocus="emptyElement('status')" maxlength="50">
	
    <div>Confirm Password:</div>
    <input id="p2" type="password"  onblur="checkpassword()" maxlength="50">
    ...
    <span id="status"></span>
	<a href = "login.php">Logeaza-te, daca ai deja cont</a>
  </form>
</body>
</html>